...
//     config:{"a":{"value":2,"range":[0,30]},"b":
//     {"value":-0.66,"range":[-1,1]},"zindex":{"value":-1, // Changed zindex value
//         "range":[-9999999,9999999]},"aspect":{"value":2.049092916257581},
//         "ignoreShapeAspect":{"value":true},
//         "shapePosition":{"value":{"x":0,"y":0}},
//         "shapeScale":{"value":{"x":0.5,"y":0.5}},"shapeEdgeSoftness"
//         :{"value":0,"range":[0,0.5]},"shapeRadius":{"value":0,"range":[0,2]}
    ...
    document.querySelector(".main").addEventListener("click", function () {
        if (!animating) {
            ...
            gsap.to(h1s[index], {
                ...
                duration: 1,
                onComplete: function () {
                    gsap.set(this.target[0], { top: "100%" });
                    animating = false;
                },
            });
            index === h1s.length - 1 ? (index = 0) : index++;
            // gsap.set(h1s[index], { top: "100%" });
             // Reset the top property of the next element
            gsap.to(h1s[index], {
                top: "-=100%",
                ease: Expo.easeInOut,
                duration: 1
